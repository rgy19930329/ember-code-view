...
define('dummy/helpers/obj-val', ['exports', 'ember'], function (exports, _ember) {
    ...
    exports.readObjVal = readObjVal;

    function readObjVal(_ref) {
        var _ref2 = _slicedToArray(_ref, 2);
        ...
        obj = obj || {};
        return _ember['default'].get(obj, String(key));
    }

    exports['default'] = _ember['default'].Helper.helper(readObjVal);
});
  ...
  exports["default"] = Ember.HTMLBars.template((function () {
    return {
      ...
      buildFragment: function buildFragment(dom) {
        ...
        dom.setAttribute(el1, "class", "container yahei");
      ...
      statements: [["content", "outlet", ["loc", [null, [5, 8], [5, 18]]], 0, 0, 0, 0]],
      locals: [],
      templates: []
    };
  })());
